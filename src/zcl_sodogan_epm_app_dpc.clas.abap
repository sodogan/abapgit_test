class ZCL_SODOGAN_EPM_APP_DPC definition
  public
...
protected section.
  ...
  methods PRODUCTS_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_SODOGAN_EPM_APP_MPC=>TS_PRODUCT
    raising
  ...
  methods PRODUCTS_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_SODOGAN_EPM_APP_MPC=>TT_PRODUCT
  ...
  methods SALESORDERITEMS_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SODOGAN_EPM_APP_MPC=>TS_SALEORDERITEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERITEMS_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SODOGAN_EPM_APP_MPC=>TT_SALEORDERITEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERS_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SODOGAN_EPM_APP_MPC=>TS_SALESORDER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SALESORDERS_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SODOGAN_EPM_APP_MPC=>TT_SALESORDER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_SODOGAN_EPM_APP_DPC IMPLEMENTATION.
...
*&* This class has been generated on 11/21/2021 21:31:49 in client 100
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_SODOGAN_EPM_APP_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA salesorders_update_entity TYPE zcl_sodogan_epm_app_mpc=>ts_salesorder.
 DATA salesorderitems_update_entity TYPE zcl_sodogan_epm_app_mpc=>ts_saleorderitem.
 DATA products_update_entity TYPE zcl_sodogan_epm_app_mpc=>ts_product.
...
*&*   generated methods inside the DPC provider subclass - ZCL_SODOGAN_EPM_APP_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA salesorders_get_entityset TYPE zcl_sodogan_epm_app_mpc=>tt_salesorder.
 DATA salesorderitems_get_entityset TYPE zcl_sodogan_epm_app_mpc=>tt_saleorderitem.
 DATA products_get_entityset TYPE zcl_sodogan_epm_app_mpc=>tt_product.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorders_get_entity TYPE zcl_sodogan_epm_app_mpc=>ts_salesorder.
 DATA salesorderitems_get_entity TYPE zcl_sodogan_epm_app_mpc=>ts_saleorderitem.
 DATA products_get_entity TYPE zcl_sodogan_epm_app_mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data.       "#EC NEEDED
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA salesorders_create_entity TYPE zcl_sodogan_epm_app_mpc=>ts_salesorder.
 DATA salesorderitems_create_entity TYPE zcl_sodogan_epm_app_mpc=>ts_saleorderitem.
 DATA products_create_entity TYPE zcl_sodogan_epm_app_mpc=>ts_product.
 DATA lv_entityset_name TYPE string.
